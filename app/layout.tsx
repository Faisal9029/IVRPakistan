...
export const metadata: Metadata = {
  ...
  description:
    "Dr. Vicky Kumar delivers advanced image-guided interventional radiology treatments in Karachi.",
};
  ...
  return (
    ...
    >
      <body
        ...
        className="min-h-full flex flex-col bg-[#f5fbff] text-slate-950"
      >
        {children}
